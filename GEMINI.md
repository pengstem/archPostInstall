...
*   **DPMS Automation:** `dpms-toggle` script and systemd timers manage display power and suspend/resume specific applications (configured in `configs/archpostinstall/dpms.conf`).
