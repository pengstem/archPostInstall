...
*   **DPMS Automation:** `dpms-toggle` plus `archpostinstall-dpms-lock-monitor.service` manage display power and app shutdown/restore on lock/unlock (configured in `configs/archpostinstall/dpms.conf`).
