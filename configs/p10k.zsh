# Generated by Powerlevel10k configuration wizard on 2025-06-21 at 01:13 CST.
...
() {
  ...
  # quiet is required by 85-fortune-cowsay.zsh: the greeting intentionally writes
  # console output during initialization; p10k buffers and replays it above the
  # first prompt, and quiet suppresses the accompanying warning.
